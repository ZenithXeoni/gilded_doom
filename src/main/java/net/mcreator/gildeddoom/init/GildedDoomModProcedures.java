...
import net.mcreator.gildeddoom.procedures.PurgatoryFuckingDiesProcedure;
...
import net.mcreator.gildeddoom.procedures.PendingPurgatoryTimeIsUpProcedure;
import net.mcreator.gildeddoom.procedures.PendingDeathEffectExpiresProcedure;
import net.mcreator.gildeddoom.procedures.ObjectivePunishmentProcedure;
import net.mcreator.gildeddoom.procedures.NotrackingwhendeadProcedure;
import net.mcreator.gildeddoom.procedures.NopeNotHappeningProcedure;
import net.mcreator.gildeddoom.procedures.NeptuniteOnlyProcedure;
import net.mcreator.gildeddoom.procedures.InPurgatoryProcedure;
...
public class GildedDoomModProcedures {
	public static void load() {
		...
		new NeptuniteOnlyProcedure();
		new InPurgatoryProcedure();
		new ThornsProcedure();
		new PurgatoryFuckingDiesProcedure();
		new PendingPurgatoryTimeIsUpProcedure();
		new GildedBruteHelmetTickEventProcedure();
		new NopeNotHappeningProcedure();
		new TrackingTomeRightclickedProcedure();
		new NotrackingwhendeadProcedure();
		new GildedBruteLeggingsTickEventProcedure();
		new FreeMeRightclickedProcedure();
		new CleansingTomeRightclickedProcedure();
		new AntiSuicidalEscapeProcedure();
		new BleedingObsidianGenProcedure();
		new DuckRightClickedOnEntityProcedure();
		new BrutalTomeRightclickedProcedure();
