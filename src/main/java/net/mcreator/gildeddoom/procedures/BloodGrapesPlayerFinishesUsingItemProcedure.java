...
public class BloodGrapesPlayerFinishesUsingItemProcedure {
	...
	public static void execute(Map<String, Object> dependencies) {
		...
		if (Mth.nextInt(RandomSource.create(), 1, 200) == 0 && new Object() {
			...
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, new BlockPos(x, y, z), SoundEvents.SOUL_SAND_BREAK, SoundSource.NEUTRAL, 1, 1);
				} else {
					_level.playLocalSound(x, y, z, SoundEvents.SOUL_SAND_BREAK, SoundSource.NEUTRAL, 1, 1, false);
				}
			}
			{
				Entity _ent = entity;
